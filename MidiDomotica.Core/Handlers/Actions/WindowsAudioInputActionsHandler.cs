...
namespace MidiDomotica.Core.Handlers.Actions
{
    ...
    {
        public IEnumerable<object> GetInputDevices()
        {
            return WindowsAudioInputTranslator.GetDevices();
        }

        public string GetInputName(string deviceId)
        {
            return WindowsAudioInputTranslator.GetName(deviceId);
        }

        public string GetInputId(string deviceName)
        {
            return WindowsAudioInputTranslator.GetId(deviceName);
        }
    }
}
